...
\student{Зобков Д. А.}
\studentt{Костусев В. А.}
\group{13541/2}
\teacher{Абрамов Н. А.}
% \teacherr{}
\papertype{Курсовая работа}
\lessontype{Методы и средства цифровой обработки информации}
% \theme{Логическое проектирование автомата, распознающего формальный язык}
% \variant[~\textnumero]{2}
% \titleright{45}
